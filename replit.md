...
- Routes: `/` → Homepage with latest reviews; `/review/:slug` → any review by slug; `/report` → Report a Scam form; `/about` → About page with team profiles; `/privacy` → Privacy Policy page (GDPR/CCPA compliant)
